...
Using the terminology developed earlier, we can think of the activity of humans in a market as constituting a measurement process $r$, projecting the complexity of the world onto the single dimension of price.
...
\subsection{Dialectical Processes}
